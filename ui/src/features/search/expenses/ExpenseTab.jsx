    ...
    return [
      ...
      },
      {
        ...
        valueFormatter: ({ value }) =>
          moment(value, FORMATS.YYYYMMDDHHmmss).format(FORMATS.DDMMMYYYYHHMM),
      },
      {
        field: "transDt",
        sortable: false,
      ...
      },
      {
        ...
        valueGetter: ({ row }) =>
          row.accounts.from ? formatAmt(row.accounts.from.balanceBf, false) : "-",
      },
      {
        field: "fromAf",
        sortable: false,
        ...
        valueGetter: ({ row }) =>
          row.accounts.from ? formatAmt(row.accounts.from.balanceAf, false) : "-",
      },
      {
        field: "toAc",
        sortable: false,
      ...
      },
      {
        ...
        renderHeader: () => <TrendingFlatIcon fontSize="small" />,
        valueGetter: ({ row }) =>
          row.accounts.to ? formatAmt(row.accounts.to.balanceBf, false) : "-",
      },
      {
        field: "toAf",
        sortable: false,
        ...
        renderHeader: () => <KeyboardTabIcon fontSize="small" />,
        valueGetter: ({ row }) =>
          row.accounts.to ? formatAmt(row.accounts.to.balanceAf, false) : "-",
      },
      {
        field: "flag",
        sortable: false,
